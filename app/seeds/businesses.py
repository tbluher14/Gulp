...
def seed_businesses():
  test_one = Business(
    ...
    zip_code='12345', website='google.com', phone='0123456789', description='Test1', owner_id=1)
  test_two = Business(
    name='Test2', address='Test2', city='Test2', state='Test2', country='Test2',
    zip_code='12345', website='google.com', phone='0123456789', description='Test2', owner_id=2)
  test_three = Business(
    name='Test3', address='Test3', city='Test3', state='Test3', country='Test3',
    zip_code='12345', website='google.com', phone='0123456789', description='Test3', owner_id=3)
